 ...
 * @since 1.7
 * 
 * @function 	pwapro_get_addons()					Add-ons of SuperPWA
 ...
 * 									'pwapro_min_version'	=> '1.7' // min version of SuperPWA required to use the add-on.
 *								)
 *		);
 *
...
function pwapro_addons_interface_render() {
	...
	<div class="wrap">
		<h1><?php _e( 'Add-Ons for', 'pwa-pro' ); ?> SuperPWA <sup><?php echo SUPERPWA_VERSION; ?></sup></h1>
		
		<p><?php _e( 'Add-Ons extend the functionality of SuperPWA.', 'pwa-pro' ); ?></p>
						...
						<div class="plugin-card-bottom">
							<div class="column-compatibility">
								...
								if ( pwapro_addons_status( $slug ) == 'active' ) {
									...
									_e( '<span class="compatibility-compatible"><strong>Compatible</strong> with your version of SuperPWA</span>', 'pwa-pro' ); 
								} 
								else { 
									_e( '<span class="compatibility-incompatible"><strong>Please upgrade</strong> to the latest version of SuperPWA</span>', 'pwa-pro' );
								} ?>
							</div>
						</div>
						...
						<div class="plugin-card plugin-card-pwapro-newsletter" style="background: #fdfc35 url('<?php echo SUPERPWA_PATH_SRC . 'admin/img/email.png'; ?>') no-repeat right top;">
							...
							<div class="plugin-card-top" style="min-height: 178px;">
								...
								<div class="name column-name" style="margin: 0px 10px;">
									<h3><?php _e( 'SuperPWA Newsletter', 'pwa-pro' ); ?></h3>
								</div>
								
								<div class="desc column-description" style="margin: 0px 10px;">
									<p><?php _e( 'Learn more about Progressive Web Apps<br>and get latest updates about SuperPWA', 'pwa-pro' ); ?></p>
								</div>
